 ...
 *
 * DASHBOARD MIRROR of convex/lib/videoEmbeds.ts (the canonical
 * server-side module). Behavior parity is pinned by the web-bridge
 * contract test (same discipline as safeLinks / key grammar).
 *
