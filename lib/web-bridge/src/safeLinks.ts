 ...
 *
 * DASHBOARD MIRROR of convex/lib/safeLinks.ts (the canonical server-side
 * module). The web-bridge contract test pins behavior parity between
 * the two files, exactly as it does for the
