    ...
    <div className="site">
      ...
      <main id="top">
        <section className="hero">
          <div className="hero-copy"><div className="eyebrow">Technology • Automation • Yield • Administration</div><h1>Run your website like a business system.</h1><p>TAYA gives organizations a secure command center for website content, events, forms, media, SEO and client operations—without giving everyday users access to the code or locked design system.</p><div className="actions"><a className="button" href="#contact">Request a Demo →</a><a className="button secondary" href="#platform">Explore TAYA</a></div><div className="checks"><span>✓ Protected layouts</span><span>✓ Role-based access</span><span>✓ Operational automation</span></div></div>
          <div className="dashboard-card"><div className="card-head"><span><b>TAYA COMMAND CENTER</b><small>Website operations overview</small></span><span className="shield">✓</span></div><div className="stats"><div><b>12</b><span>Active Sites</span></div><div><b>24</b><span>Open Forms</span></div><div><b>18</b><span>Upcoming Events</span></div><div><b>486</b><span>Media Assets</span></div></div><div className="automation"><b>Automated lifecycle controls</b><p>Full classes close automatically. Past events move out of active listings. Your team stays in control without repetitive cleanup.</p></div></div>
        </section>
