    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <ChevronLeftIcon className={cn(CALENDAR_CLASSES.chevronIcon, className)} {...props} />
            )
          }
          ...
          if (orientation === "right") {
            return (
              <ChevronRightIcon
                className={cn(CALENDAR_CLASSES.chevronIcon, className)}
                {...props}
              />
            )
          }
          ...
          return (
            <ChevronDownIcon className={cn(CALENDAR_CLASSES.chevronIcon, className)} {...props} />
          )
        },
        ...
        WeekNumber: ({ children, ...props }) => {
          return (
            <td {...props}>
              <div className={CALENDAR_CLASSES.weekNumberCell}>
                {children}
              </div>
            </td>
          )
