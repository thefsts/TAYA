...
const DROPDOWN_MENU_CLASSES = {
  subTrigger: "flex cursor-default select-none items-center gap-2 rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-accent data-[state=open]:bg-accent [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  ...
  indicatorSpan: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center",
  checkIcon: "h-4 w-4",
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(DROPDOWN_MENU_CLASSES.subTrigger, inset && "pl-8", className)}
    {...props}
  >
    {children}
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(DROPDOWN_MENU_CLASSES.subContent, className)}
    {...props}
  />
))
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Item
    ref={ref}
    className={cn(DROPDOWN_MENU_CLASSES.item, inset && "pl-8", className)}
    {...props}
  />
))
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <span className={DROPDOWN_MENU_CLASSES.indicatorSpan}>
      <DropdownMenuPrimitive.ItemIndicator>
        <Check className={DROPDOWN_MENU_CLASSES.checkIcon} />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.CheckboxItem>
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ref={ref}
    className={cn(DROPDOWN_MENU_CLASSES.radioItem, className)}
    {...props}
  >
    <span className={DROPDOWN_MENU_CLASSES.indicatorSpan}>
      <DropdownMenuPrimitive.ItemIndicator>
        <Circle className={DROPDOWN_MENU_CLASSES.circleIcon} />
      </DropdownMenuPrimitive.ItemIndicator>
    </span>
    {children}
  </DropdownMenuPrimitive.RadioItem>
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(DROPDOWN_MENU_CLASSES.label, inset && "pl-8", className)}
    {...props}
  />
))
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn(DROPDOWN_MENU_CLASSES.shortcut, className)}
      {...props}
    />
  )
}
