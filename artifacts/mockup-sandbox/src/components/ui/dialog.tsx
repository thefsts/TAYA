...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(DIALOG_CLASSES.overlay, className)}
    {...props}
  />
))
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(DIALOG_CLASSES.content, className)}
      {...props}
    >
      {children}
      <DialogPrimitive.Close className={DIALOG_CLASSES.closeButton}>
        <X className={DIALOG_CLASSES.closeIcon} />
...
const DialogHeader = ({
  ...
  <div
    className={cn(DIALOG_CLASSES.header, className)}
    {...props}
  />
)
...
const DialogFooter = ({
  ...
  <div
    className={cn(DIALOG_CLASSES.footer, className)}
    {...props}
  />
)
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn(DIALOG_CLASSES.title, className)}
    {...props}
  />
))
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Description
    ref={ref}
    className={cn(DIALOG_CLASSES.description, className)}
    {...props}
  />
))
